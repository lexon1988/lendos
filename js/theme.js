...
function themeAccrodion () {
  if ($('.theme-accordion _3E .panel.panel').length) {
    $('.theme-accordion _3E .panel.panel').on('show.bs.collapse', function (e) {
          var heading = $(this).find('.panel-heading');
          heading.addClass("active-panel");
          
    });
    
    $('.theme-accordion _3E .panel.panel').on('hidden.bs.collapse', function (e) {
        var heading = $(this).find('.panel-heading');
